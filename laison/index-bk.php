...
<head>
    ...
    <style type="text/css">
        ...
        .motif-lable-box .sub-nav-active {
            background-color: #000000;
        }
        .motif-lable-box .sub-nav-active p{
            color: #ffffff;
        }
...
<body>
            ...
            <div class="row">
                ...
                <nav class="codr">
                    <div style="padding-top:6px;margin-top:2px;margin-bottom:1%;">
                        ...
                        ?>
                        <ul class="sm sm-clean" id="main-menu" style="width: auto;" data-smartmenus-id="14132519898276223">
                            <?php
                            ...
                            ?>
                                ...
                                <li style="margin-right: 10px;">
                                    <button type="button" class="btn btn-secondary category_list" data-category_id="<?= $category_id ?>" href="#" title="<?php echo $row['nom'] ?>" id="<?php echo $row['nom'] ?>"> <?php $translate->__($row['nom']); ?> </button>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
                ...
                <div class="col-md-5 col-lg-5 col-sd-5 col-xs-5 " style="padding-left: 2%;">
                        ...
                        <div class="shape-radio-btns-wraper">
                            <div class="main-flex-box-wraper">
                                ...
                                <div class="flex-shape-box">
                                    <input class="form-check-input" checked type="radio" name="img_format" id="shape10by10">
                                    <label for="shape10by10">
                                        <p class="format">20x20</p>
                                    </label>
                                </div>

                                <div class="flex-shape-box">
                                    <input class="form-check-input" type="radio" name="img_format" id="shape10by11">
                                    <label for="shape10by11">
                                        <p class="format">10x10</p>
                                    </label>
                                </div>

                                <div class="flex-shape-box">
                                    <input class="form-check-input hexagonal-shape custom-widht-adjust" type="radio" name="img_format" id="shape10by14">
                                    <label for="shape10by14">
                                        <p class="format">Hexagonal</p>
                                    </label>
                                </div>

                                <div class="flex-shape-box">
                                    <input class="form-check-input octagonal-shape" type="radio" name="img_format" id="shape10by13">
                                    <label for="shape10by13">
                                        <p class="format">Octagonal</p>
                                    </label>
                                </div>
                            </div>
                        </div>

                        <h1 class="common-heading-text mt-3">Etape 2 : choisir votre motif</h1>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <div class="rg-image">
                                            ...
                                            <a id="rotatresult" href="#" style="color:#000000;float: right;"><span class="glyphicon glyphicon-repeat"></span>
                    ...
                    <style>
                        ...
                        label.top-search-bar input::placeholder {
                            font-size: 14px;
                            color: #999;
                        }

                        .shape-radio-btns-wraper input {
                            width: 50px;
                            height: 50px;
                        ...
                        .hexagonal-shape {
                            /* clip-path: polygon(51% 0, 100% 28%, 100% 70%, 51% 100%, 51% 100%, 0 72%, 0 29%); */
                            clip-path: polygon(51% 0, 100% 29%, 100% 71%, 51% 100%, 50% 100%, 0 72%, 0 28%);
                        }
                        ...
                        /*input.motif-label-radio[type="radio"]:checked+label {
                            background-color: #000000;
                        }*/

                        /*input.motif-label-radio[type="radio"]:checked+label p {
                            color: #ffffff;
                        }*/
                        ...
                        .nicol-image-srroller::-webkit-scrollbar {
                            display: none;
                        }


                        .btns-flex-bar button {
                        ...
                        .btn-devis,
                        button.btn-devis.btn.btn-success.btn-responsive{
                ...
                <div class="col-md-6 col-lg-6 col-sd-6 col-xs-6 bc">
                    ...
                    <div class="chart-flex-control-box">
                        ...
                        <div class="btns-flex-bar">
                            ...
                            <button id="pop1" value="btn btn-large" class="btn-devis btn btn-responsive" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fas fa-cube"></i>3D</button>
                            ...
                            <button id="imprimer" value="btn btn-primary btn-large" class="btn-devis btn  btn-responsive"><i class="fas fa-print"></i><?php $translate->__('Imprimer'); ?> </button>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if(border_image){
                            ...
                            $('.border_name').html(border_name);
                        }
                        else{
                            $('.border_image').attr('src', default_image);
                        }
                        let table = $('#table-wrap').html()
                        $('#DevisModal #table-wrap').html(table)
                        $('#DevisModal #table-wrap img').addClass('hsn_css')
                    },
                });
            });
            ...
            $(".es-carousel ul li a").live('click', function(e) {
                // alert($(this).find('img').data('cat_name'));
                $("#result").removeClass("cun");
                if (!$(this).hasClass('borderhref')) {
                    ...
                    if (!$(this).hasClass('f14') && !$(this).hasClass('artiste') && !$(this).hasClass('hex')) {
                        $.ajax({
                            type: "GET",
                            url: 'pasteImage.php',
                            data: 'img=' + $("#result").attr("src") + '&cat_name=' + $(this).find('img').data('cat_name') + '&format=' + $('.flex-shape-box input:checked').siblings('label').find('p').text(),
                            success: function(result) {
                                result = JSON.parse(result);
                ...
                if (!$(this).hasClass('artiste')) {
                    ...
                    if ($("#result").hasClass('hex')) {
                        ...
                        $.ajax({
                            type: "GET",
                            url: 'getColor.php',
                            data: 'coords=' + pos + '&range=1&img=' + sr + '&color=' + rs,
                            success: function(res) {
                                $.ajax({
                                    type: "GET",
                                    url: 'pasteImage.php',
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-10" role="dialog" aria-labelledby="myLargeModalLabel1" aria-hidden="false" id="2dcontt">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 p-0">
                                    <label for="input1" class="modal-input-forms">
                                        <h1 class="common-heading-text ms-5">Societe</h1>
                                ...
                                <div class="col-xl-4 p-0">
                                    <label for="input2" class="modal-input-forms">
                                        <h1 class="common-heading-text ms-5">Nom*</h1>
                                ...
                                <div class="col-xl-4 p-0">
                                    <label for="input3" class="modal-input-forms">
                                        <h1 class="common-heading-text ms-5">Prenom*</h1>
                                ...
                                <div class="col-xl-12 p-0">
                                    <label for="input4" class="modal-input-forms">
                                        <h1 class="common-heading-text ms-5">Address*</h1>
                                ...
                                <div class="col-xl-4 p-0">
                                    <label for="input5" class="modal-input-forms">
                                        <h1 class="common-heading-text ms-5">Code Postal*</h1>
                                ...
                                <div class="col-xl-4 p-0">
                                    <label for="input6" class="modal-input-forms">
                                        <h1 class="common-heading-text ms-5">Ville*</h1>
                                ...
                                <div class="col-xl-4 p-0">
                                    <label for="input7" class="modal-input-forms">
                                        <h1 class="common-heading-text ms-5">Pays*</h1>
                                ...
                                <div class="col-xl-4 p-0">
                                    <label for="input8" class="modal-input-forms">
                                        <h1 class="common-heading-text ms-5">Telephone*</h1>
                                ...
                                <div class="col-xl-4 p-0">
                                    <label for="input9" class="modal-input-forms">
                                        <h1 class="common-heading-text ms-5">Fax*</h1>
                                ...
                                <div class="col-xl-4 p-0">
                                    <label for="input10" class="modal-input-forms">
                                        <h1 class="common-heading-text ms-5">Email*</h1>
...
<!--                                </div>-->
                                ...
                                <div class="col-xl-12 p-0">
                                    <div class="modal-image-box-wraper" style="margin-top: 0;">
                                        <p>Image:</p>
                                        <div id="table-wrap" class="imp flex-1-box" style="margin-left: 90px;"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 p-0">
                                    ...
                                    <label for="input11" class="modal-input-forms form-images-inputs">
                                        ...
                                        <input type="text" name="pattern_amount" required id="input11">
                                    </label>
                                </div>
                                ...
                                <div class="col-xl-6 p-0">
                                    ...
                                    <label for="input11" class="modal-input-forms form-images-inputs">
                                        <h1 class="common-heading-text me-3">Quantite*</h1>
                                        <input type="text" name="border_amount" required id="input11">
                                    </label>
                                </div>

                                <div class="col-xl-12">
                                    <label for="input12" class="modal-input-forms">
