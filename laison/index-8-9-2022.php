                        ...
                        <ul class="px-0 sm sm-clean" id="main-menu" style="width: auto;" data-smartmenus-id="14132519898276223">
                            ...
                            ?>
                                ...
                                <li style="margin-right: 10px;">
                                    <button type="button" class="btn btn-info text-white btn-lg px-5 category_list" data-category_id="<?= $category_id ?>" href="#" title="<?php echo $row['nom'] ?>" id="<?php echo $row['nom'] ?>"> <?php $translate->__($row['nom']); ?> </button>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
...
<style>
    ...
    h1.common-heading-text {font-size: 21px;font-weight: 600;text-align: left !important;margin-right: 20px;}
    ...
    label.top-search-bar input::placeholder {font-size: 14px;color: #999;}
        ...
        .main-flex-box-wraper {display: flex;justify-content: space-between;width: 60%;margin-top: 20px;}
        .flex-shape-box label p {font-size: 14px;color: #000000;margin: 5px 0;font-weight: 600;}
        ...
        .form-check-input:checked {background-color: #0dcaf0 !important;}
        ...
        .modal-input-forms {display: flex;justify-content: space-between;margin: 20px 0;}
        ...
        .custom-90 {width: 86.7%!important;}
        ...
        .form-images-inputs {justify-content: flex-end;}
        .text-area-input {width: 100%;height: 100px;border: 1px solid #999999;outline: none;padding: 10px;}
        ...
        a.btn-devis.btn.btn-responsive {padding: 7px 0;margin-top: 10px;}
</style>
